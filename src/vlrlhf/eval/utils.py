...
def run_vqa(model_path: str, dataset, collator, accelerator, processor_path: str = None, batch_size=16, do_sample=False):

    model, processor, generation_kwargs = load_model_and_processor(
        model_path, processor_path, use_flash_attention_2=False
    )
